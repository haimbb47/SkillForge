...
"[project]/hooks/useBadges.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useBadges(parameters) {
    ...
    const fetchBadges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBadges.useCallback[fetchBadges]": async ()=>{
            if (!contract) {
                setBadges([]);
                return;
            }
            ...
            try {
                ...
                try {
                    ...
                    events.forEach({
                        "useBadges.useCallback[fetchBadges]": (event)=>{
                    ...
                    }["useBadges.useCallback[fetchBadges]"]);
                    // 并行获取每个证书的详情
                    const badgePromises = Array.from(badgeIds).map({
                        "useBadges.useCallback[fetchBadges].badgePromises": async (id)=>{
                            try {
                                ...
                                try {
                                    ...
                                    console.log("Error fetching path ".concat(courseId, ":"), e);
                                }
                                return {
                                    id,
                                ...
                                console.log("Error fetching badge ".concat(id, ":"), e);
                                return null;
                            }
                        }
                    }["useBadges.useCallback[fetchBadges].badgePromises"]);
                    const results = await Promise.all(badgePromises);
                    results.forEach({
                        "useBadges.useCallback[fetchBadges]": (badge)=>{
                            if (badge) {
                ...
                // 按铸造时间倒序排列
                allBadges.sort({
                    "useBadges.useCallback[fetchBadges]": (a, b)=>b.claimedAt - a.claimedAt
                }["useBadges.useCallback[fetchBadges]"]);
                setBadges(allBadges);
            } catch (e) {
    ...
    // 获取单个证书详情
    const fetchBadge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBadges.useCallback[fetchBadge]": async (badgeId)=>{
            ...
            try {
                ...
                console.error("Error fetching badge ".concat(badgeId, ":"), e);
                return null;
            }
        }
    }["useBadges.useCallback[fetchBadge]"], [
        contract
    ]);
    // 解密证书分数
    const decryptBadgeScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBadges.useCallback[decryptBadgeScore]": async (badgeId)=>{
    ...
    }["useBadges.useCallback[decryptBadgeScore]"], [
        instance,
        ethersSigner,
        contractAddress,
    ...
    // 为证书解密分数并更新状态
    const decryptAndUpdateBadge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useBadges.useCallback[decryptAndUpdateBadge]": async (badgeId)=>{
            const score = await decryptBadgeScore(badgeId);
            if (score !== null) {
                setBadges({
                    "useBadges.useCallback[decryptAndUpdateBadge]": (prev)=>prev.map({
                            "useBadges.useCallback[decryptAndUpdateBadge]": (badge)=>badge.id === badgeId ? {
                                    ...badge,
                                    decryptedScore: score
                                } : badge
                        }["useBadges.useCallback[decryptAndUpdateBadge]"])
                }["useBadges.useCallback[decryptAndUpdateBadge]"]);
            }
            return score;
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useBadges.useEffect": ()=>{
            ...
            const filter = contract.filters.BadgeClaimed();
            const handleClaimed = {
                "useBadges.useEffect.handleClaimed": ()=>{
...
_s(useBadges, "R4IMaaBj89O+r77artq1pMblGmc=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/badges/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBadges$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useBadges.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function BadgesPage() {
    ...
    const { badges, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBadges$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBadges"])({
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 34,
                        columnNumber: 13
                    }, this) : badges.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: badge.earner ? "".concat(badge.earner.slice(0, 16), "...") : 'Unknown'
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/badges/page.tsx",
                                                        lineNumber: 63,
                                                        columnNumber: 23
                                            ...
                                            badge.decryptedScore && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(BadgesPage, "RLArGS6KQCp5PGwc9dTHRXIIUz8=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useBadges$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBadges"]
    ];
});
_c = BadgesPage;
var _c;
...
//# sourceMappingURL=_0fc63543._.js.map